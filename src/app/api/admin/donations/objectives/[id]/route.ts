...
export async function PUT(request: NextRequest, { params }: { params: { id: string } }) {
  ...
  await db.update(donationObjectives).set(updates).where(eq(donationObjectives.id, params.id));
...
export async function DELETE(request: NextRequest, { params }: { params: { id: string } }) {
  ...
  await db.delete(donationObjectives).where(eq(donationObjectives.id, params.id));
